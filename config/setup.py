...
# #     #         cysparse_ext_params_INT64_FLOAT64 = copy.deepcopy(ext_params)
#         cysparse_ext_params_INT64_FLOAT64['include_dirs'].extend(cysparse_rootdir)
#         cysparse_ext_params_INT64_FLOAT64['include_dirs'].extend(lldl_include_dirs)
#         lldl_ext.append(Extension(name="lldl.src.cysparse_lldl_INT64_FLOAT64",
#                                   sources=['lldl/src/cysparse_lldl_INT64_FLOAT64.pxd',
#                                            'lldl/src/cysparse_lldl_INT64_FLOAT64.pyx'],
#                                   **cysparse_ext_params_INT64_FLOAT64))
#
#     # 
